...
export const createEventSchema = insertEventSchema
    ...
    .extend({
        title: z
            ...
            .max(60, {
                error: 'Event title cannot be more than 60 chars long',
            }),
        excerpt: z
            .string()
            .min(12, { error: 'Event excerpt must be at least 6 chars long' })
            .max(80, {
                error: 'Event excerpt cannot be more than 80 chars long',
            }),
        text: z
            .string()
            .min(20, { error: 'Event text must be at least 20 chars long' })
            .max(2000, {
                error: 'Event text cannot be more than 2000 chars long',
            }),
